...
def train_data(datalist):
    ...
    return bayesianerrors, adaboosterrors, knnerrors, svmerrors
...
def main():
    ...
    bayesianerrors, adaboosterrors, knnerrors, svmerrors = train_data(
        datalist=datalist)
    ...
    # show_err(ids=["original",  "bayesian", "adaboost", "knn", "svm"], errors=[
    #          originalerrors, bayesianerrors, adaboosterrors, knnerrors, svmerrors])
